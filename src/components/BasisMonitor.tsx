    ...
    <div className="space-y-6 font-sans">
      <section className="rounded-xl border border-border bg-surface p-6 shadow-sm">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-ink-secondary">Provider marks, durable price history, official benchmark references, and liquidity signals only when they can be verified.</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 border-t border-border pt-5 sm:grid-cols-4">
          ...
          <Metric label="Pyth references" value={String(benchmarkedCount)} detail="Entitled official indices only" />
        </div>
      </section>
      ...
      {selectedItem && (
        <section className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          ...
          <div className="mt-4 flex items-end justify-between gap-4">
            <div><div className="text-xs text-ink-tertiary">{selectedItem.symbol} · {selectedItem.provider}</div><div className="mt-1 font-mono text-2xl font-bold text-ink-primary">{formatUsd(selectedItem.providerMarkPriceUsd)}</div></div>
