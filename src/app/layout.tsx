...
export const metadata: Metadata = {
  ...
  description:
    '1-click thematic index baskets for tokenized equities and pre-IPO assets on Solana, powered by PreStocks, Tessera, Pyth Hermes, and Meteora Dynamic Bonding Curves.',
};
