...
export const INITIAL_BASKETS: BasketDefinition[] = [
  {
    ...
    symbol: 'AIT',
    description: 'High-conviction synthetic basket tracking frontier artificial intelligence pioneers across LLMs, agents, and prediction markets.',
    category: 'ai',
    providerMode: 'multi',
    navUsd: 801.32,
    navChange24h: 3.82,
  ...
  },
  {
    ...
    symbol: 'PREX',
    description: 'Pure PreStocks ecosystem basket for the PreStocks $10k bounty track. Zero non-PreStocks assets.',
    category: 'custom',
